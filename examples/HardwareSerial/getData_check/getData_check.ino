...
//   Получаем данные от модуля:                                                    //
     ...
     int32_t  ec   = sensor.getEC();                                               //   Получаем приведённую удельную электропроводность жидкости.
     int32_t  s    = sensor.get_S();                                               //   Получаем измеренную  удельную электропроводность жидкости.
...
//   Выводим результат:                                                            //
     ...
     Serial.print( (String) "EC "  + ec  + " мкСм/см, "    );                      //   Выводим приведённую удельную электропроводность жидкости.
     Serial.print( (String) "S "   + s   + " мкСм/см, "    );                      //   Выводим измеренную  удельную электропроводность жидкости.
