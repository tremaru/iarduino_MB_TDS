...
//   - если скорость известна, то строки с другими скоростями можно удалить.                       //
     ...
     if(!f){ rs485.begin(  2400); while(!rs485); delay(10); Serial.print('.'); f=sensor.begin(); } //   Инициируем работу с TDS-метром на скорости   2400, без указания адреса (адрес будет найден автоматически).
     if(!f){ rs485.begin(  4800); while(!rs485); delay(10); Serial.print('.'); f=sensor.begin(); } //   Инициируем работу с TDS-метром на скорости   4800, без указания адреса (адрес будет найден автоматически).
     if(!f){ rs485.begin(  9600); while(!rs485); delay(10); Serial.print('.'); f=sensor.begin(); } //   Инициируем работу с TDS-метром на скорости   9600, без указания адреса (адрес будет найден автоматически).
     if(!f){ rs485.begin( 19200); while(!rs485); delay(10); Serial.print('.'); f=sensor.begin(); } //   Инициируем работу с TDS-метром на скорости  19200, без указания адреса (адрес будет найден автоматически).
     if(!f){ rs485.begin( 38400); while(!rs485); delay(10); Serial.print('.'); f=sensor.begin(); } //   Инициируем работу с TDS-метром на скорости  38400, без указания адреса (адрес будет найден автоматически).
     if(!f){ rs485.begin( 57600); while(!rs485); delay(10); Serial.print('.'); f=sensor.begin(); } //   Инициируем работу с TDS-метром на скорости  57600, без указания адреса (адрес будет найден автоматически).
     if(!f){ rs485.begin(115200); while(!rs485); delay(10); Serial.print('.'); f=sensor.begin(); } //   Инициируем работу с TDS-метром на скорости 115200, без указания адреса (адрес будет найден автоматически).
