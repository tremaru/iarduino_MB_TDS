...
#include <iarduino_Modbus.h>													//	Подключаем файл iarduino_Modbus.h - для работы по протоколу Modbus.
																				//
#define DEF_MODEL_TDS 8															//	Идентификатор модели - константа.
																				//
...
class iarduino_MB_TDS{															//
	...
	/**	Пользовательские функции **/											//
		...
		int32_t			get_S			(void						);			//	Объявляем  функцию получения измеренной  удельной электропроводности.	Параметры функции: нет. Функция возвращает измеренную удельную электропроводность жидкости в мкСм/см, или -1 при провале чтения.
		int32_t			getEC			(void						);			//	Объявляем  функцию получения приведённой удельной электропроводности.	Параметры функции: нет. Функция возвращает приведённую удельную электропроводность жидкости в мкСм/см, или -1 при провале чтения.
