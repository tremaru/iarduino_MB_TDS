...
//   sensor.set_T(25);                                                             //   Указываем опорную температуру жидкости. Обычно используют 20°С или 25°С. По умолчанию 25°С.
     ...
     Serial.println(F("2 - Выводить удельная электропроводность в мкСм/см."));     //
     Serial.println(F("3 - Выводить приведённая электропроводность в мкСм/см."));  //
     ...
     //  Меняем тип данных выводимых на дисплей:                                   //
         switch(i){                                                                //
             case 1: sensor.print(MB_TDS_Ro);                                      //   Указываем модулю выводить на дисплей общее измеренное сопротивление между выводами щупа.
                     Serial.print(F("1) Общее измеренное сопротивление "));        //   Сопротивление выводится в Ом целым числом, или в кОм с одним знаком после запятой.
             ...
             case 2: sensor.print(MB_TDS_S);                                       //   Указываем модулю выводить на дисплей измеренную удельную электропроводность.
                     Serial.print(F("2) Удельная электропроводность "));           //   Электропроводность выводится в мкСм/см целым числом, или в мСм/см с одним знаком после запятой.
                     Serial.print(F("'S' в мкСм/см. \r\n"));                       //
                     break;                                                        //
             case 3: sensor.print(MB_TDS_EC);                                      //   Указываем модулю выводить на дисплей приведённую удельную электропроводность.
                     Serial.print(F("3) Приведённая электропроводность "));        //   Электропроводность выводится в мкСм/см целым числом, или в мСм/см с одним знаком после запятой.
                     Serial.print(F("'EC' в мкСм/см. \r\n"));                      //
                     break;                                                        //
             case 4: sensor.print(MB_TDS_TDS);                                     //   Указываем модулю выводить на дисплей общее количество растворённых твёрдых веществ (по умолчанию).
                     Serial.print(F("4) Кол-во растворённых твёрдых веществ "));   //   Количество выводится в ppm (pro pro mille) целым числом, или ‰ (pro mille) с одним знаком после запятой.
             ...
             case 5: sensor.print(MB_TDS_5V);                                      //   Указываем модулю выводить на дисплей измеренное напряжения питания на шине +5V.
                     Serial.print(F("5) Напряжение питания на шине +5V "));        //   Напряжение выводится в В с двумя знаками после запятой.
             ...
             case 6: sensor.print(MB_TDS_Vo);                                      //   Указываем модулю выводить на дисплей напряжение виртуального 0 на входе ОУ.
                     Serial.print(F("6) Напряжение виртуального 0 на входе ОУ ")); //   Напряжение выводится в В с двумя знаками после запятой.
                     Serial.print(F("'Vo' в В. \r\n"));                            //
                     break;                                                        //
             case 7: sensor.print(MB_TDS_Vout);                                    //   Указываем модулю выводить на дисплей напряжение на выходе ОУ.
                     Serial.print(F("7) Напряжение на выходе ОУ"));                //   Напряжение выводится в В с двумя знаками после запятой.
             ...
             case 8: sensor.print(MB_TDS_Vsen);                                    //   Указываем модулю выводить на дисплей напряжение на входе датчика при положительной полярности.
                     Serial.print(F("8) Напряжение на входе датчика"));            //   Напряжение выводится в В с двумя знаками после запятой.
